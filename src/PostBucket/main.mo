...
public shared ({ caller }) func validate(input : Any) : async Validate {
    ...
    private func addOrUpdatePost(isNew: Bool, postId: Text, principalId : Text, title : Text,
        subtitle : Text, headerImage : Text, content : Text, isDraft : Bool, tagNames: [Text], creator : Text, isPublication : Bool, category : Text, isPremium: Bool) : () {
    ...
    public shared (msg) func save(postModel : PostSaveModel) : async SaveResult {
        ...
        addOrUpdatePost(isNew, postId, principalId, postModel.title, postModel.subtitle,
            postModel.headerImage, postModel.content, postModel.isDraft, postModel.tagNames, postModel.creator, isPublication, postModel.category, isPremium);
