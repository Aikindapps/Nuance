export const idlFactory = ({ IDL }) => {
  ...
  const Result_7 = IDL.Variant({ 'ok' : MetadataLegacy, 'err' : CommonError });
  ...
  const Result = IDL.Variant({
    'ok' : IDL.Vec(
      IDL.Tuple(TokenIndex, IDL.Opt(Listing), Metadata, TokenIdentifier__1)
    ),
    'err' : IDL.Text,
  });
  const EXTNFT = IDL.Service({
    ...
    'canisterId' : IDL.Func([], [IDL.Principal], ['query']),
    'details' : IDL.Func([TokenIdentifier__1], [Result_11], ['query']),
    ...
    'ext_bearer' : IDL.Func([TokenIdentifier__1], [Result_8], ['query']),
    ...
    'ext_marketplaceList' : IDL.Func([ListRequest], [Result_4], []),
    'ext_marketplaceList_multiple' : IDL.Func(
        [IDL.Vec(ListRequest)],
        [IDL.Vec(Result_4)],
        [],
      ),
    ...
    'ext_marketplaceSettle' : IDL.Func([AccountIdentifier__1], [Result_4], []),
    ...
    'ext_metadata' : IDL.Func([TokenIdentifier__1], [Result_9], ['query']),
    'ext_mint' : IDL.Func(
    ...
    'ext_saleSettle' : IDL.Func([AccountIdentifier__1], [Result_5], []),
    ...
    'extdata_supply' : IDL.Func([TokenIdentifier__1], [Result_3], ['query']),
    ...
    'getAccessKeyIndexByTokenIndex' : IDL.Func(
        [IDL.Text],
        [AccessKeyIndex],
        ['query'],
      ),
    ...
    'getOwnersOfPost' : IDL.Func(
        [IDL.Text],
        [IDL.Vec(IDL.Tuple(AccessKeyIndex, AccountIdentifier__1))],
        ['query'],
      ),
    ...
    'getUserAllowedPostIds' : IDL.Func(
        [IDL.Text],
        [IDL.Vec(IDL.Text)],
        ['query'],
      ),
    ...
    'indexToTokenId' : IDL.Func([TokenIndex], [TokenIdentifier__1], ['query']),
