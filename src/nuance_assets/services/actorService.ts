...
const FASTBLOCKS_EMAIL_OPT_IN_CANISTER_ID = process.env.FASTBLOCKS_EMAIL_OPT_IN_CANISTER_ID || '';
const METRICS_CANISTER_ID = process.env.METRICS_CANISTER_ID || '';
const NOTIFICATIONS_CANISTER_ID = process.env.NOTIFICATIONS_CANISTER_ID || '';
const POST_CORE_CANISTER_ID = process.env.POST_CORE_CANISTER_ID || '';
const POST_RELATIONS_CANISTER_ID = process.env.POST_RELATIONS_CANISTER_ID || '';
const STORAGE_CANISTER_ID = process.env.STORAGE_CANISTER_ID || '';
