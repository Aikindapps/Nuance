...
export const images = {
  ...
  NUANCE_LOGO: imagesPath + 'nuance-logo-black.svg',
  //NUANCE_LOGO_BLACK: imagesPath + 'nuance-logo-black.svg',
  NUANCE_LOGO_BLUE_TEXT: imagesPath + 'nuance_logo_blue_text.webp',
  NUANCE_LOGO_BLACK_TEXT: imagesPath + 'nuance_logo_black_text.svg',
  ...
  NUANCE_LOGO_NFT_BLACK: imagesPath + 'nuance_logo_with_nft_black.svg',
  ...
  NUANCE_LOGO_UNSUFFICIENT_BALANCE_BLACK:
  ...
  HIGH_TECH_IMAGE_NEW: imagesPath + 'high_tech_image_new.svg',
...
export const icons = {
  ...
  THUMBS_UP_DARK: iconsPath + 'thumbs-up-dark.svg',
  THUMBS_DOWN: iconsPath + 'thumbs-down.svg',
  THUMBS_DOWN_DARK: iconsPath + 'thumbs-down-dark.svg',
  REPLY: iconsPath + 'reply.svg',
  REPLY_DARK: iconsPath + 'reply-dark.svg',
  SHARE: iconsPath + 'share.svg',
  SHARE_DARK: iconsPath + 'share-dark.svg',
  REPORT: iconsPath + 'reportComment.svg',
  REPORT_DARK: iconsPath + 'reportComment-dark.svg',
