...
module {
  ...
  public let NUA_TRANSACTION_HISTORY_CANISTER_ID = CanisterIds.NUA_TRANSACTION_HISTORY_CANISTER_ID;
  ...
  public let MERT_DASHBOARD_PRINCIPAL_ID = "d5vhw-rtcgy-f24gp-x5aua-fxkoa-li4fx-75f7g-7nwhy-v7ikl-qowla-tae";
  ...
  public let NUA_TRANSACTION_HISTORY_CANISTER_ADMINS = [
    SNS_GOVERNANCE_CANISTER,
    CYCLES_DISPENSER_CANISTER_ID,
  ];
