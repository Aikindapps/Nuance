...
actor User {
    ...
    private func handleExists(handle: Text) : Bool {
        ...
        let reservedPaths : [Text] = ["api", "_", "assets", "share"];
                ...
                switch(publicationWritersEditorsPrincipals) {
                    case(?principalsArray) {
                        for(principal in principalsArray.vals()){
                            ...
                            var userPublicationObject : PublicationObject = {isEditor= false; publicationName = ""};
                            ...
                            if(userPublicationObject.publicationName != "" and user.handle != ""){
                                ...
                                userPublicationsBuffer.filterEntries(func (index: Nat, pubObj: PublicationObject) : Bool {
