export const idlFactory = ({ IDL }) => {
  ...
  const Result_5 = IDL.Variant({ 'ok' : RegisteredCanister, 'err' : IDL.Text });
  const Result_3 = IDL.Variant({ 'ok' : IDL.Vec(IDL.Text), 'err' : IDL.Text });
  const Result = IDL.Variant({ 'ok' : IDL.Null, 'err' : IDL.Text });
  const Result_4 = IDL.Variant({ 'ok' : TopUp, 'err' : IDL.Text });
  ...
  return IDL.Service({
    ...
    'addCanister' : IDL.Func([AddCanisterModel], [Result_5], []),
    'availableCycles' : IDL.Func([], [IDL.Nat], ['query']),
    'batchRegisterAdmin' : IDL.Func([IDL.Principal], [Result_3], []),
    'batchRegisterPlatformOperator' : IDL.Func([IDL.Principal], [Result_3], []),
    'batchUnregisterAdmin' : IDL.Func([IDL.Principal], [Result_3], []),
    ...
    'checkRegisteredCanister' : IDL.Func([IDL.Text], [Result_4], []),
    'checkStorageBucketCanisters' : IDL.Func([], [], []),
    'depositCyclesToCanister' : IDL.Func([IDL.Text, IDL.Nat], [Result_4], []),
    ...
    'getRegisteredCanister' : IDL.Func([IDL.Text], [Result_5], ['query']),
    'getStaleCanisters' : IDL.Func([], [IDL.Vec(StaleCanister)], ['query']),
    'getStatus' : IDL.Func([], [IDL.Text], ['query']),
    'getStorageBucketTopUpConfig' : IDL.Func([], [IDL.Nat, IDL.Nat], ['query']),
    'getTopUp' : IDL.Func([IDL.Text], [Result_4], ['query']),
    ...
    'setStorageBucketTopUpConfig' : IDL.Func(
        [IDL.Nat, IDL.Nat],
        [Result_1],
        [],
      ),
