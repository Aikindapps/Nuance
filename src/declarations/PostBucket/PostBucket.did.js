export const idlFactory = ({ IDL }) => {
  ...
  const Result_4 = IDL.Variant({ 'ok' : PostBucketType__1, 'err' : IDL.Text });
  ...
  const PostBucket = IDL.Service({
    ...
    'get' : IDL.Func([IDL.Text], [Result_4], ['query']),
    ...
    'getPremiumArticle' : IDL.Func([IDL.Text], [Result_4], []),
