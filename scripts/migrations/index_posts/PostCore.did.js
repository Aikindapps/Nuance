const PostCoreIDL = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    getTotalAmountOfTipsReceived: IDL.Func([], [IDL.Nat], ['composite_query']),
    ...
    getUserPosts: IDL.Func([IDL.Text], [IDL.Vec(PostKeyProperties)], ['query']),
    ...
    isEditorPublic: IDL.Func([IDL.Text, IDL.Principal], [IDL.Bool], ['query']),
    isThereEnoughMemory: IDL.Func([], [IDL.Bool], ['query']),
    isWriterPublic: IDL.Func([IDL.Text, IDL.Principal], [IDL.Bool], ['query']),
    ...
    upgradeAllBuckets: IDL.Func([IDL.Text, IDL.Vec(IDL.Nat8)], [Result_1], []),
